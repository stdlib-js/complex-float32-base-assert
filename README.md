...
```javascript
import { isAlmostEqual, isEqual, isNotEqual, isSameValue, isSameValueZero } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert@esm/index.mjs';
```
