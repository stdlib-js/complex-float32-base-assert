...
```javascript
import { isAlmostEqual, isAlmostSameValue, isEqual, isNotEqual, isSameValue, isSameValueZero } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert@v0.2.1-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert@v0.2.1-esm/index.mjs';
