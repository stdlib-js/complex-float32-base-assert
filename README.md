...
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/complex-float32-base-assert/tags). For example,

```javascript
import assert from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { isAlmostEqual, isAlmostSameValue, isEqual, isNotEqual, isSameValue, isSameValueZero } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert@esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/complex-float32-base-assert/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/complex-float32-base-assert/actions/workflows/test.yml?query=branch:v0.2.1
...
[@stdlib/complex/float32/base/assert/is-almost-equal]: https://github.com/stdlib-js/complex-float32-base-assert-is-almost-equal/tree/esm

[@stdlib/complex/float32/base/assert/is-almost-same-value]: https://github.com/stdlib-js/complex-float32-base-assert-is-almost-same-value/tree/esm

[@stdlib/complex/float32/base/assert/is-equal]: https://github.com/stdlib-js/complex-float32-base-assert-is-equal/tree/esm

[@stdlib/complex/float32/base/assert/is-not-equal]: https://github.com/stdlib-js/complex-float32-base-assert-is-not-equal/tree/esm

[@stdlib/complex/float32/base/assert/is-same-value-zero]: https://github.com/stdlib-js/complex-float32-base-assert-is-same-value-zero/tree/esm
